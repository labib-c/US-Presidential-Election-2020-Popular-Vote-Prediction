...
The model chosen to model the proportion of voters who will vote for Donald Trump versus Joe Biden in the 2020 United States Presidential Election is a Logistic Regression model represented by the following equation (Eq. 1):
$$
...
From Table 1, we observe the slope for the “black/african american/negro” race level has a value of -2.28, which is one of the steepest decrease from our model. This shows that the log odds of a voter voting for Trump if they identify as a member of this race decreases by a factor of 2.28.
